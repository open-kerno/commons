/**
 * Structured logger built on top of Winston.
 * Supports logfmt and JSON output formats, configurable log levels,
 * and field masking for sensitive data.
 *
 * Originally based on the open-source version of @mercadoni/elementals.
 * @see https://www.npmjs.com/package/@mercadoni/elementals
 */
  ...
  return {
    logfmt: combine(
      ...
      printf((info) => {
        ...
        const logData = { ...(data['data'] as object), stacktrace: data['stacktrace'] };
